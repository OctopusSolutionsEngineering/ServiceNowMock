...
import (
	...
	"github.com/mcasperson/ServiceNowMock/internal/application/domain"
)
...
func ChangeId(c *gin.Context) {
	...
	c.Data(http.StatusOK, "application/json; charset=utf-8", []byte(`{
	  "result": {
		...
		"sys_updated_on": {
		  "display_value": "2026-02-16 16:45:10",
		  "value": "2026-02-17 00:45:10",
		  "display_value_internal": "2026-02-16 16:45:10"
		},
		"type": {
